...
class MySubstitionsViewTestCase(TestCase):
    ...
    def test_save_and_delete_substitution(self):
        self.client.post('/account/',
                         {'username': 'pauline@free.fr',
                          'password': '1234'})
        ...
        response = self.client\
            .post('/account/substitutions/2/delete/')
        response = self.client.get(response.url)
...
class ProfileUpdateViewTestCase(TestCase):
    ...
    def test_change_password(self):
        self.client.post('/account/pass_update/',
                         {'password1': '4321',
                          'password2': '4321'})
        self.client.get('/account/logout/')
    ...
    def test_change_email(self):
        self.client.post('/account/email_update/',
